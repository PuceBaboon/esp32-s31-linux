/*
 * Based on ESP-IDF's a2dp_gatts_coex example.
...
static void bt_app_avrc_ct_evt_hdl(uint16_t event, void *param)
{
    ...
    case ESP_AVRC_CT_CHANGE_NOTIFY_EVT:
        bt_avrc_md_ct_evt_hdl(event, param);
        bt_avrc_common_ct_notify_evt_handler(rc->change_ntf.event_id,
...
void bt_app_a2d_cb(esp_a2d_cb_event_t event, esp_a2d_cb_param_t *param)
{
    ...
    case ESP_A2D_AUDIO_CFG_EVT:
        bt_app_work_dispatch(bt_a2d_evt_int_codec_hdl, event, param,
                             sizeof(esp_a2d_cb_param_t), NULL, NULL);
        break;
    case ESP_A2D_PROF_STATE_EVT:
    case ESP_A2D_SNK_PSC_CFG_EVT:
    case ESP_A2D_SNK_SET_DELAY_VALUE_EVT:
    case ESP_A2D_SNK_GET_DELAY_VALUE_EVT:
        bt_app_work_dispatch(bt_a2d_evt_def_hdl, event, param,
                             sizeof(esp_a2d_cb_param_t), NULL, NULL);
        break;
    default:
...
{
    coex_bench_record_a2dp_data(len);
                     ...
                     esp_avrc_ct_cb_param_t *param)
{
    switch (event) {
    case ESP_AVRC_CT_METADATA_RSP_EVT:
        bt_app_work_dispatch(bt_app_avrc_ct_evt_hdl, event, param,
                             sizeof(esp_avrc_ct_cb_param_t),
                             bt_avrc_common_copy_metadata,
                             bt_avrc_common_free_metadata);
        break;
    case ESP_AVRC_CT_CONNECTION_STATE_EVT:
    case ESP_AVRC_CT_PASSTHROUGH_RSP_EVT:
    case ESP_AVRC_CT_CHANGE_NOTIFY_EVT:
    ...
    case ESP_AVRC_CT_PROF_STATE_EVT:
        bt_app_work_dispatch(bt_app_avrc_ct_evt_hdl, event, param,
                             sizeof(esp_avrc_ct_cb_param_t), NULL, NULL);
        break;
    default:
        ESP_LOGE(BT_RC_CT_TAG, "Invalid AVRC event: %d", event);
        break;
                     ...
                     esp_avrc_tg_cb_param_t *param)
{
    ...
    case ESP_AVRC_TG_PROF_STATE_EVT:
        bt_app_work_dispatch(bt_avrc_common_tg_evt_def_hdl, event, param,
                             sizeof(esp_avrc_tg_cb_param_t), NULL, NULL);
        break;
    case ESP_AVRC_TG_CONNECTION_STATE_EVT:
    case ESP_AVRC_TG_SET_ABSOLUTE_VOLUME_CMD_EVT:
    case ESP_AVRC_TG_REGISTER_NOTIFICATION_EVT:
        bt_app_work_dispatch(bt_avrc_avc_tg_evt_hdl, event, param,
                             sizeof(esp_avrc_tg_cb_param_t), NULL, NULL);
        break;
    default:
